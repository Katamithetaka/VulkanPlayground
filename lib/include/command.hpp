...
// inline bool runProgram(const std::string &command, const std::vector<std::string> &args = std::vector<std::string>{}, std::string *stdout_pipe = nullptr, std::string *stderr_pipe = nullptr)
// {
...
// inline std::string generate_random_file()
// {
